...
import { Box, Button, Flex, FormControl, FormLabel, Heading,Text, Input, Textarea,
    useColorMode,
            ...
            <Box maxWidth="500px" mx="auto" p='4'>
                ...
                >
                    ...
                    <label id="theme-toggle-button">
                        <input type="checkbox" id="toggle" onClick={toggleColorMode} onChange={e=>console.log(e.target.value)}/>
